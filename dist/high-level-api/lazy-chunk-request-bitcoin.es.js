...
import { i as isAppVersionSupported, a as isLegacyApp, Coin, Network, getBip32Path, AddressTypeBitcoin, ErrorState, ErrorType } from './ledger-api.es.js';

/// <reference path="../../../lib/type-shims.d.ts" />
class RequestBitcoin extends Request {
    static _isNewApiSupported(app, appVersion) {
    ...
    coin = Coin.BITCOIN;
    minRequiredAppVersion = '1.3.8'; // first version supporting web usb
    get requiredApp() {
    ...
    async _getLowLevelApi(transport) {
        if (!RequestBitcoin._lowLevelApiPromise
            ...
            // altcoins.
            (LowLevelApi) => new LowLevelApi({ transport, currency: apiToUse }), (e) => {
    ...
    async _loadLowLevelApi() {
        try {
            return (await [import('./lazy-chunk-index.es.js'), import('./lazy-chunk-bitcoin-lib.es.js'), import('./lazy-chunk-_commonjsHelpers.es.js'), import('./lazy-chunk-index.es3.js'), import('./lazy-chunk-_virtual_process.es.js'), import('./lazy-chunk-index.es4.js'), import('./lazy-chunk-sha256.es.js'), import('./lazy-chunk-events.es.js'), import('./lazy-chunk-Btc.es.js')][8]).default;
        }
        catch (e) {
    ...
    async _loadBitcoinLib() {
        try {
            return await [import('./lazy-chunk-index.es.js'), import('./lazy-chunk-sha256.es.js'), import('./lazy-chunk-_virtual_process.es.js'), import('./lazy-chunk-_commonjsHelpers.es.js'), import('./lazy-chunk-events.es.js'), import('./lazy-chunk-bitcoin-lib.es.js')][5].then(function (n) { return n.d; });
        }
        catch (e) {
            throw new ErrorState(ErrorType.LOADING_DEPENDENCIES_FAILED, `Failed loading dependencies: ${e instanceof Error ? e.message : e}`, this);
        }
    ...
    async _loadSha256() {
        try {
            ...
            return (await [import('./lazy-chunk-_commonjsHelpers.es.js'), import('./lazy-chunk-index.es.js'), import('./lazy-chunk-sha256.es.js')][2].then(function (n) { return n.s; })).default; // eslint-disable-line import/no-extraneous-dependencies
        }
        catch (e) {
            throw new ErrorState(ErrorType.LOADING_DEPENDENCIES_FAILED, `Failed loading dependencies: ${e instanceof Error ? e.message : e}`, this);
        }
