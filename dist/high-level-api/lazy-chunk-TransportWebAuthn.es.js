...
Object.defineProperty(scrambling, "__esModule", {
  value: true
});
var wrapApdu_1 = scrambling.wrapApdu = wrapApdu;
...
const attemptExchange = (apdu, timeout, scrambleKey) => {
  ...
  .then(r => buffer.Buffer.from(r.response.signature));
};
/**
...
export { TransportWebAuthn as default };
